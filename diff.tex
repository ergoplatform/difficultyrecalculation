...
The simpliest case of pair linear regression (\(y=kx+b)\) is defined as follows:
...
\item{It is simple enough to use integer arithmetic for all computational steps.}
\end{enumerate}
...
Finally, we also want to present simulation results that that show how our method proposed in Section \ref{sec:improved} improves over Bitcoin’s difficulty update algorithm.
