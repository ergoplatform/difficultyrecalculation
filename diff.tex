...
$$
  \begin{cases}
    k= {2 \cdot \sum_{n=i-N}^{i-1} (D_n \cdot n) - (2 \cdot i-N-1) \cdot \sum_{n=i-N}^{i-1} D_n \over N \cdot ( (i-N)^2 + (i-1)^2 + \frac{(2 \cdot i-N-1)^2}{2} )} \\
    b= \sum_{n=i-N}^{i-1} \frac{D_n}{N} - \frac{k \cdot (2 \cdot i-N-1)}{2} \\
    D_i= k \cdot i + b
  \end{cases}
$$
